...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <form action="login.php" method="POST" class="space-y-4">
            ...
            <button type="submit" class="bg-blue-500 text-white p-2 rounded w-full hover:bg-blue-600">Accedi</button>
        </form>

        <p class="mt-4 text-center">Non hai un account? <a href="register.php" class="text-blue-500">Registrati</a></p>
    </div>
</body>
